...
(custom-set-faces
 ...
 '(org-agenda-done ((t (:foreground "Grey70" :weight normal :strike-through t))))
 '(org-done ((t (:foreground "Grey70" :weight normal :strike-through t))))
 '(org-todo ((t (:foreground "Red" :background "#002b36" :weight extra-bold))))
 '(org-headline-done ((((class color) (min-colors 16) (background dark)) (:foreground "Grey70" :strike-through t)))) ;;Grey7070 light
 '(term ((t (:background "Dark" :foreground "#839496"))))
 )
